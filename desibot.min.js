(function loadDesiBotCSS() {
  ...
  link.rel = "stylesheet";
  link.href = "https://cdn.jsdelivr.net/gh/darksmogai/desiaibot@v1.0.6/desibot.min.css";
...
window.initDesiBot = function ({
  ...
  window.addEventListener("load", () => {
    ...
    style.innerHTML = `
      ...
      #desibot-launcher {
        background: linear-gradient(135deg, var(--desibot-primary), #1b1b1b) !important;
      ...
      #desibot-header {
        background: linear-gradient(135deg, var(--desibot-primary), #65a4ff) !important;
      }
      #desibot-send {
    ...
    <svg viewBox="0 0 500 80" preserveAspectRatio="none"
      ...
      <path d="M0,30 C150,90 350,-30 500,30 L500,80 L0,80 Z" fill="#f0f4f8"></path>
          ...
          <div id="desibot-footer">
            ...
            <div class="desibot-footer-title">Powered By <span>Darksmog.ai</span> </div>
          </div>
        `;
      ...
      function handleInput() {
        ...
        if (step === 0) {
          if (/^\d{10}$/.test(text)) {
            ...
            appendMessage("⚠️ Enter a valid 10-digit mobile number.", "bot");
            input.value = "";
          }
        } else if (step === 1) {
          userName = text;
      ...
      if (isFirstTime) {
        appendMessage("🤖 Hello! I’m DesiBot. Please enter your mobile number to begin.", "bot");
        isFirstTime = false;
      }
    };
  });
